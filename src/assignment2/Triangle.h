...
public:
  ...
  Vector3f color[3]; /*the color of the triangle*/
  Vector2f tex_coords[3]; /*the texture coordinates of the triangle*/
  Vector3f normal[3];     /*the normal vectors of the triangle*/
